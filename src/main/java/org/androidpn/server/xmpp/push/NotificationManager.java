 ...
 */
public class NotificationManager implements AbstractNotificationManager{

	private static final String NOTIFICATION_NAMESPACE = "androidpn:iq:notification";

	private final Log log = LogFactory.getLog(getClass());

	private SessionManager sessionManager;//使用SessionManager在当前session集合中查找相应的client链接。,通过相应session，向client发送消息。

	private NotificationService notificationService;//实现类逻辑暂时为空
	...
	public NotificationManager() {
		...
		System.out.println("**********************NotificationManager中属性sessionManager:"+sessionManager+"****************************************************");
	...
	public void sendBroadcast(String apiKey, String title, String message,
		...
		try {
			notificationService.createNotifications(notificationMOs);//逻辑暂时为空
		} catch (Exception e) {
